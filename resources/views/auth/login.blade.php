    ...
    <div class="relative min-h-[80vh] flex items-center justify-center pt-28 pb-16 px-4 speed-lines">
        ...
        <div class="relative z-10 w-full max-w-md bg-[#1A1A1A] border-4 border-[#F5F0E6] p-8 shadow-[8px_8px_0px_#F5F0E6] space-y-6 text-[#F5F0E6]">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <button type="submit" class="manga-button-primary w-full py-3.5 text-sm uppercase rounded-lg text-white font-extrabold cursor-pointer">
                    LOGIN →
                </button>
            </form>
            ...
            <div class="relative flex items-center justify-center my-4">
                <div class="border-t-2 border-[#F5F0E6]/30 w-full"></div>
                <span class="bg-[#1A1A1A] px-3 text-xs uppercase font-black tracking-widest text-zinc-400">atau</span>
                <div class="border-t-2 border-[#F5F0E6]/30 w-full"></div>
            </div>

            <!-- Google OAuth Button -->
            <a href="{{ route('auth.google') }}" class="manga-button w-full py-3.5 text-sm rounded-lg text-white font-extrabold flex items-center justify-center gap-3 cursor-pointer bg-[#141414] hover:bg-[#202020] border-2 border-[#F5F0E6] shadow-[3px_3px_0px_#F5F0E6]">
            ...
            <div class="text-center pt-3 border-t-2 border-zinc-800 text-xs text-zinc-400 font-bold flex items-center justify-between">
                <span>Belum punya akun? <a href="{{ route('register') }}" class="text-[#E63946] hover:underline ml-1">Daftar</a></span>
                <span class="text-zinc-500 font-mono">EVO AUTH</span>
            </div>

            <div class="text-center text-[11px] text-zinc-500 font-mono">
                Default Seeder: admin@evonime.com / Admin12345
            </div>
